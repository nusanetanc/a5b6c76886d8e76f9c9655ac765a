...
function typeCheck() { 
    if (document.getElementById('apartment').checked) {
        ...
        $.getJSON("https://grry-v-2-nurhandiyudi.c9users.io/location/apartemens/"+selectedArr, function(json){
    ...
    if (document.getElementById('residential').checked) {
      ...
      $.getJSON("https://grry-v-2-nurhandiyudi.c9users.io/location/residentials/"+selectedArr, function(json){
          var arrLocation = json;
          arrLocation.forEach(Locationfunc);
      });
      function Locationfunc(array_element){
...
function selectLocationApartment() {
  ...
  if( selectedArr == '[Not Coverage]'){
    ...
    $.getJSON("https://grry-v-2-nurhandiyudi.c9users.io/location/towers/"+selectedArr, function(json){
        var arrLocation = json;
        arrLocation.forEach(Locationfunc);
    });
    function Locationfunc(array_element){
...
var locations = document.getElementById('floorselect');
  $.getJSON("https://grry-v-2-nurhandiyudi.c9users.io/location/floors/"+selectedArr, function(json){
      var arrLocation = json;
      arrLocation.forEach(Locationfunc);
  });
  function Locationfunc(array_element){
...
var locations = document.getElementById('unitSelect');
  $.getJSON("https://grry-v-2-nurhandiyudi.c9users.io/location/units/"+selectedArr, function(json){
      var arrLocation = json;
      arrLocation.forEach(Locationfunc);
  });
  function Locationfunc(array_element){
